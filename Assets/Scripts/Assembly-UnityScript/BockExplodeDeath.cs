...
public class BockExplodeDeath : MonoBehaviour
{
	...
	public virtual void Die()
	{
		...
		for (int i = 0; (float)i < num; i++)
		{
			...
			GameObject @object = PoolsManager.GetObject(explodeObjectType, thisTransform.position + onUnitSphere * distanceOfObjectsFromCenter + vector, thisTransform.rotation);
