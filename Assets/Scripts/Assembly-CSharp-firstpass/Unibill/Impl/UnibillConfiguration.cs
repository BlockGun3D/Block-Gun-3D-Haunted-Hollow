...
namespace Unibill.Impl
{
	...
	{
		[CompilerGenerated]
		private sealed class _003CUnibillConfiguration_003Ec__AnonStorey8
		{
			internal PurchasableItem item;

			internal bool _003C_003Em__D(PurchasableItem x)
			{
				return x.Id == item.Id;
			}
		}
		...
		[CompilerGenerated]
		private sealed class _003CgetItemById_003Ec__AnonStorey9
		{
			internal string id;

			internal bool _003C_003Em__12(PurchasableItem x)
			{
				return x.Id == id;
			}
		}
		...
		[CompilerGenerated]
		private sealed class _003CgetCurrency_003Ec__AnonStoreyA
		{
			internal string id;

			internal bool _003C_003Em__13(VirtualCurrency x)
			{
		...
		public List<PurchasableItem> AllNonConsumablePurchasableItems
		{
			get
			{
				...
				{
					_003C_003Ef__am_0024cache11 = _003Cget_AllNonConsumablePurchasableItems_003Em__E;
				}
		...
		public List<PurchasableItem> AllConsumablePurchasableItems
		{
			get
			{
				...
				{
					_003C_003Ef__am_0024cache12 = _003Cget_AllConsumablePurchasableItems_003Em__F;
				}
		...
		public List<PurchasableItem> AllSubscriptions
		{
			get
			{
				...
				{
					_003C_003Ef__am_0024cache13 = _003Cget_AllSubscriptions_003Em__10;
				}
		...
		public List<PurchasableItem> AllNonSubscriptionPurchasableItems
		{
			get
			{
				...
				{
					_003C_003Ef__am_0024cache14 = _003Cget_AllNonSubscriptionPurchasableItems_003Em__11;
				}
		...
		public UnibillConfiguration(string json, RuntimePlatform runtimePlatform, Uniject.ILogger logger, List<ProductDefinition> runtimeProducts = null)
		{
			...
			if (runtimeProducts != null)
			{
				...
				{
					_003CUnibillConfiguration_003Ec__AnonStorey8 _003CUnibillConfiguration_003Ec__AnonStorey = new _003CUnibillConfiguration_003Ec__AnonStorey8();
					Dictionary<string, object> hash = new Dictionary<string, object> { 
					{
						"@purchaseType",
						runtimeProduct.Type.ToString()
					} };
					_003CUnibillConfiguration_003Ec__AnonStorey.item = new PurchasableItem(runtimeProduct.PlatformSpecificId, hash, CurrentPlatform);
					if (!inventory.Exists(_003CUnibillConfiguration_003Ec__AnonStorey._003C_003Em__D))
					{
						inventory.Add(_003CUnibillConfiguration_003Ec__AnonStorey.item);
					}
				}
			}
		...
		{
			_003CgetItemById_003Ec__AnonStorey9 _003CgetItemById_003Ec__AnonStorey = new _003CgetItemById_003Ec__AnonStorey9();
			_003CgetItemById_003Ec__AnonStorey.id = id;
			PurchasableItem purchasableItem = inventory.Find(_003CgetItemById_003Ec__AnonStorey._003C_003Em__12);
		...
		{
			_003CgetCurrency_003Ec__AnonStoreyA _003CgetCurrency_003Ec__AnonStoreyA = new _003CgetCurrency_003Ec__AnonStoreyA();
			_003CgetCurrency_003Ec__AnonStoreyA.id = id;
			return currencies.Find(_003CgetCurrency_003Ec__AnonStoreyA._003C_003Em__13);
		}
		...
		[CompilerGenerated]
		private static bool _003Cget_AllNonConsumablePurchasableItems_003Em__E(PurchasableItem x)
		{
			return x.PurchaseType == PurchaseType.NonConsumable;
		}

		[CompilerGenerated]
		private static bool _003Cget_AllConsumablePurchasableItems_003Em__F(PurchasableItem x)
		{
			return x.PurchaseType == PurchaseType.Consumable;
		}

		[CompilerGenerated]
		private static bool _003Cget_AllSubscriptions_003Em__10(PurchasableItem x)
		{
			return x.PurchaseType == PurchaseType.Subscription;
		}

		[CompilerGenerated]
		private static bool _003Cget_AllNonSubscriptionPurchasableItems_003Em__11(PurchasableItem x)
		{
			return x.PurchaseType != PurchaseType.Subscription;
		}
	}
