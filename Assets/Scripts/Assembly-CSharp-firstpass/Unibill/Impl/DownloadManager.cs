...
namespace Unibill.Impl
{
	public class DownloadManager
	{
		...
		private sealed class _003Cdownload_003Ec__Iterator3 : IEnumerator, IDisposable, IEnumerator<object>
		{
			...
			internal FileStream _003C_0024s_31_003E__12;

			internal long _003CrangeStart_003E__13;

			internal long _003CrangeEnd_003E__14;

			internal int _003ClastProgress_003E__15;

			internal string _003Cheader_003E__16;

			internal IHTTPRequest _003Cresponse_003E__17;

			internal int _003Cprogress_003E__18;
			...
			{
				//Discarded unreachable code: IL_00f4, IL_0a76
				...
				{
				case 0u:
					_003C_003Ef__this.createDataPathIfNecessary(bundleId);
					if (!File.Exists(_003C_003Ef__this.getZipPath(bundleId)))
					{
						...
						try
						{
							_003Cparameters_003E__1.Add("receipt", _003C_003Ef__this.getReceipt(bundleId));
						}
						catch (IOException)
						{
						...
						_003Cparameters_003E__1.Add("appId", _003C_003Ef__this.appId);
						_003Cparameters_003E__1.Add("bundleName", bundleId);
						...
						_003Cparameters_003E__1.Add("unibillVersion", "1.7.20");
				...
				case 6u:
					...
					_003C_0024s_31_003E__12 = (_003C_003Ef__this.fileStream = _003C_003Ef__this.openDownload(bundleId));
					num = 4294967293u;
					goto case 8u;
				case 8u:
				case 9u:
				...
				case 11u:
					try
					{
						...
						{
						default:
							_003CrangeStart_003E__13 = _003C_003Ef__this.fileStream.Length;
							if (_003CrangeStart_003E__13 > 0)
							{
								_003C_003Ef__this.fileStream.Seek(0L, SeekOrigin.End);
							}
							_003CrangeEnd_003E__14 = Math.Min(_003CrangeStart_003E__13 + _003C_003Ef__this.bufferSize, _003CcontentLength_003E__11);
							_003ClastProgress_003E__15 = -1;
							break;
						case 8u:
							_003Cresponse_003E__17 = _003C_003Ef__this.fetcher.getResponse();
							if (!string.IsNullOrEmpty(_003Cresponse_003E__17.error))
							{
								_003C_003Ef__this.logger.LogError("Error downloading content. Will retry.");
								_003C_003Ef__this.logger.LogError(_003Cresponse_003E__17.error);
								_0024current = _003C_003Ef__this.getRandomSleep();
								_0024PC = 9;
								flag = true;
								goto end_IL_0011;
							}
							_003Cprogress_003E__18 = (int)((float)_003CrangeEnd_003E__14 / (float)_003CcontentLength_003E__11 * 100f);
							_003Cprogress_003E__18 = Math.Min(99, _003Cprogress_003E__18);
							if (_003C_003Ef__this.onDownloadProgressedEvent != null && _003ClastProgress_003E__15 != _003Cprogress_003E__18)
							{
								_003C_003Ef__this.onDownloadProgressedEvent(bundleId, _003Cprogress_003E__18);
								_003ClastProgress_003E__15 = _003Cprogress_003E__18;
							}
							if (_003Cresponse_003E__17.bytes.Length > _003C_003Ef__this.BUFFER.Length)
							{
							...
							Buffer.BlockCopy(_003Cresponse_003E__17.bytes, 0, _003C_003Ef__this.BUFFER, 0, _003Cresponse_003E__17.bytes.Length);
							_003C_003Ef__this.bytesReceived = _003Cresponse_003E__17.bytes.Length;
						...
						case 11u:
							...
							_003CrangeStart_003E__13 = _003CrangeEnd_003E__14 + 1;
							_003CrangeEnd_003E__14 = _003CrangeStart_003E__13 + _003C_003Ef__this.bufferSize;
							_003CrangeEnd_003E__14 = Math.Min(_003CrangeEnd_003E__14, _003CcontentLength_003E__11);
							break;
						}
						if (_003CrangeStart_003E__13 < _003CrangeEnd_003E__14)
						{
							_003Cheader_003E__16 = string.Format("bytes={0}-{1}", _003CrangeStart_003E__13, _003CrangeEnd_003E__14);
							_003Cheaders_003E__7["Range"] = _003Cheader_003E__16;
							_0024current = _003C_003Ef__this.fetcher.doGet(_003CdownloadToken_003E__0, _003Cheaders_003E__7);
							_0024PC = 8;
							flag = true;
							break;
					...
					{
						if (!flag && _003C_0024s_31_003E__12 != null)
						{
							((IDisposable)_003C_0024s_31_003E__12).Dispose();
						}
					}
					goto default;
				case 12u:
					...
					{
						_003C_003Ef__this.onDownloadCompletedEvent(bundleId, _003C_003Ef__this.getContentPath(bundleId));
					}
					_0024PC = -1;
					goto default;
				default:
			...
			public void Dispose()
			{
				...
				case 11u:
					...
					{
						if (_003C_0024s_31_003E__12 != null)
						{
							((IDisposable)_003C_0024s_31_003E__12).Dispose();
						}
					}
		...
		private sealed class _003ConDownloadFailedPermanently_003Ec__AnonStorey7
		{
			...
			{
				_003C_003Ef__this.removeDownloadFromQueues(bundleId);
				_003C_003Ef__this.deleteContent(bundleId);
				if (_003C_003Ef__this.onDownloadFailedEvent != null)
				{
					try
					{
						_003C_003Ef__this.onDownloadFailedEvent(bundleId, error);
					}
		...
		public DownloadManager(IUtil util, IStorage storage, IURLFetcher fetcher, Uniject.ILogger logger, BillingPlatform platform, string appSecret, string appId)
		{
			this.util = util;
		...
		private IEnumerator download(string bundleId)
		{
			...
			if (!File.Exists(getZipPath(bundleId)))
			{
				...
				parameters.Add("unibillVersion", "1.7.20");
				...
				using (this.fileStream = openDownload(bundleId))
				{
					...
					while (rangeStart < rangeEnd2)
					{
						...
						{
							this.onDownloadProgressedEvent(bundleId, progress2);
